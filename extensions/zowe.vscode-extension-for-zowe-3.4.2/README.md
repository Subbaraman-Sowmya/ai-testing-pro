...
These bidirectional (BiDi) languages are not currently supported in Visual Studio Code. (See [Issue [#86667](https://github.com/zowe/zowe-explorer-vscode/issues/86667)](https://github.com/microsoft/vscode/issues/86667) for more information.)
